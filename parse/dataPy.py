class Data():
    ...
    def __get_best_value(self, values, best_value):
        message = ''
        i = 0
        while i < len(values):
    ...
    def get_best_buy_value(self):
        return self.__get_best_value(self.buys, self.best_buy_value)
    
    def get_best_sell_value(self):
        return self.__get_best_value(self.sells, self.best_sell_value)